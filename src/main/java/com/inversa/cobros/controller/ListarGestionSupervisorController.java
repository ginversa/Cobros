...
@Named
@ViewScoped
public class ListarGestionSupervisorController implements Serializable {
    ...
    public void init() {
        ...
        // Usuario de session...
        TblUsuario usuario = (TblUsuario) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get(ConstanteComun.USUARIO);
        ...
        if (codigoCartera != null && !codigoCartera.trim().equals("")) {
            this.gestionList = this.ejbLocal.findByCarteraANDSupervisor(gestion);
        }
